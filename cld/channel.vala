...
public abstract class Cld.Channel : AbstractObject {
 ...
 */
public interface Cld.AChannel : Channel {
 ...
 */
public interface Cld.DChannel : Channel {
}
 ...
 */
public interface Cld.IChannel : Channel {
}
 ...
 */
public interface Cld.OChannel : Channel {
}
 ...
 */
public class Cld.AIChannel : Channel, AChannel, IChannel {
 ...
 */
public class Cld.AOChannel : Channel, AChannel, OChannel {
    /* properties - from Object */
    public override string id           { get; set; }
    /* properties - from Channel */
    public override int num             { get; set; }
 ...
 */
public class Cld.DIChannel : Channel, DChannel, IChannel {
    /* properties - from Object */
    public override string id { get; set; }
    /* properties - from Channel */
    public override int num             { get; set; }
 ...
 */
public class Cld.DOChannel : Channel, DChannel, OChannel {
    /* properties - from Object */
    public override string id       { get; set; }
    /* properties - from Channel */
    public override int num         { get; set; }
